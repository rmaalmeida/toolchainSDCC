...
public class SDCCUserIncludeModifier extends UserIncludeModifier {
    public SDCCUserIncludeModifier(){
        super(SDCCUserIncludeProvider.OPT_ID, SDCCUserIncludeProvider.OPT_PROP);
    }
}
